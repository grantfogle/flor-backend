    ...
    .then(function () {
      ...
      return knex('wildflowers').insert([
        ...
        },
        {
          ...
          description: 'This woolly-stemmed, dwarf sunflower, sometimes referred to as old-man-of-the-moutains, or sun-god, is a startling surprise for the newcomer to our above-timberline tundras. Flower head is 3 to 4 inches across, the central disk, an inch in diameter, made up of over a hundred tiny, tubular, golden florets, surrounded by about 30 bright yellow rays which are flat and notched at the outer end. Plant is 5 to 15 inches tall composed of one or several woolly stems, with leaves divided into several narrow lobes. Grows on alpine slopes. Blooms from June-July.',
          image: 'http://www.ramblincameras.com/Oldman10j.jpg'
        },
        {
          name: 'Nelson\'s Larkspur',
          family: 'Buttercup Family',
          description: 'This small larkspur of the early spring looks much like the single larkspur of an old-fashioned garden. Its favorite location is near the base of a clump of scrub oak where a little snow has drifted in the winter giving that spot a bit of extra water. Flowers, 1/2 inch or more wide, are formed of 5 showy, dark blue, irregularly shaped sepals, enclosing at their base 4 much smaller petals of lighter color. Plant is 10-15 inches tall and bears rather few leaves each sub-divided into linear segments. Grows in the foothill zone. Blooms late April to early June.',
          image: 'http://2.bp.blogspot.com/-iZRJjP6td1c/TbhpMLHZD3I/AAAAAAAAAoI/zIAvEik2vn8/s1600/IMG_5012.JPG'
        },
        {
          name: 'Showy Fleabane',
          family: 'Composite Family',
          description: 'As the season advances, these aster-like flowers become the most conspicuous color notes in our high-altitude aspen groves. They come after early flowers are gone and bloom with a profusion unknown to most shade-loving plants. Grows in shady places, rich moist soil, montane and sub-alpine zones. Blooms late July-September.',
        ...
        },
        {
          name: 'Easter Daisy',
          family: 'Composite Family',
          description: 'These are among the earliest plains flowers. Their typical occurrence is as isolated plants, one here and one there between grass turfs in areas of rather tight prairie sod. Grows on grassy plains, and foothills. Blooms April-May.',
